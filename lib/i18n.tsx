...
const resources: Resources = {
  en: {
    ...
    config_fav_subtitle: "Read-only view of wishlist items from Basket/Wishlist_GetItems.",
    ...
    config_order_retake_subtitle: "List of previous orders that could be \"retaken\" (new order from an existing one).",
    ...
    config_order_hours_subtitle: "Read-only view of preferred schedule for orders (from MyStore/PrefSchedule_Get).",
  ...
  gr: {
    ...
    config_fav_subtitle: "Μόνο για ανάγνωση: στοιχεία λίστας ευχών από Basket/Wishlist_GetItems.",
    ...
    config_users_subtitle: "Λίστα χρηστών του τρέχοντος καταστήματος (μόνο ανάγνωση).",
    config_users_store_uid: "Store UID:",
    ...
    config_order_retake_subtitle: "Λίστα προηγούμενων παραγγελιών που μπορούν να \"επαναληφθούν\" (νέα παραγγελία από υπάρχουσα).",
    ...
    config_order_hours_subtitle: "Μόνο ανάγνωση: προτιμώμενο πρόγραμμα παραγγελιών (MyStore/PrefSchedule_Get).",
